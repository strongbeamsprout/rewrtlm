...
### test of efficiency of lm.rewrt/summary.lm.rewrt comparing to the original function (lm/summary.lm)
```{r}
...
### there is another Rcpp version that I wrote for realizing this regression fitting (https://github.com/strongbeamsprout/lmcpp), but the compilation situation seems to vary across different systems, so I encourage the users to download the source code and sourceCpp it as the following:
```{r}
